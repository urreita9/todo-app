...
export const TitleModeToggle = () => {
    const {dark, handleMode}=useTodo()
    return (
        <section className='todo__title'>
        <h1 className='todo__title__title'>TODO</h1>
        <div className='todo__title__icon__container' onClick={handleMode}>
            {
            dark?<i className='todo__title__icon'>
